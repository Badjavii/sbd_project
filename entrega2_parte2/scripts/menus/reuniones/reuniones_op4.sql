-- ==========================================
-- ARCHIVO: menu/reuniones/reuniones_op4.sql
-- ==========================================

-- preview reuniones realizadas
prompt ==========================================
...
-- preview miembros activos por grupo
...
begin
    ...
    dbms_output.put_line('Validacion de expulsion ejecutada para el miembro ' || &v_id_miembro || '.');
exception
